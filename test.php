...
$strAccessToken = "4st9kEFcf5U8n+v/V58EboEWfPg27cGP5c2PAK5cg+4Pvk3n6WgLwr1T+zKsTQuHqDQF92YlUpCfVbZ3VLdYQVdAqayvC1sv4Ba7QVQ/aPP/kG3yRiHp59YJhXnvShP1v6jLf+1KW0hXuXW0Q5IUaQdB04t89/1O/w1cDnyilFU=";
...
if($arrJson['events'][0]['message']['text'] == "สวัสดี"){
  ...
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "Please wait ";
}else if($arrJson['events'][0]['message']['text'] == "ฉันไม่เข้าใจคำสั่ง"){
  $arrPostData = array();
  $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
  $arrPostData['messages'][0]['type'] = "text";
  $arrPostData['messages'][0]['text'] = "Please wait ";
